...
R0=xState(2);
for ctrb=1:K
CoeffFileName=['Data/Calibration/cPhMed.mat'];
...
=RunSimulationsFromT1(CoeffFileName,x0,R0,NumSim,Param(ctrb),sHist0);
end

save( [Para.datapath 'SimDataStationaryStart.mat'],'sHist',...
