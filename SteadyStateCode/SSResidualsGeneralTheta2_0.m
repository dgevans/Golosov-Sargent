function [ res ] = SSResidualsGeneralTheta2_0( X,Para )
...
res(1:2) = x*uc2./(beta*Euc2)-uc2.*(c2-c1) - x +R*l1.*ul1; % implementability mult:mu

%res(3:4) = theta_2*R*ul1-theta_1*ul2; % wage mult : phi
res(5:6)=phi;
res(5:6) = n1*theta_1*l1-n1*c1-n2*c2-g; % resource mult xi
...
% 
% res(11:12) = theta_1*(xi+phi)-alpha_1*(1-psi)*P./(1-l1)
% -(1-psi)*R*mu*P./( (1-l1).^2 );
% 
