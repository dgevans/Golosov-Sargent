...
clc
close all
AMSSTransfers2Shocks=load('~/Golosov-Sargent/Data/temp/AMSS_Solution_tr_2shocks.mat');
AMSSTransfers3Shocks=load('~/Golosov-Sargent/Data/temp/AMSS_Solution_tr_3shocks.mat');
NumSim=10000;
...
spmd
    switch labindex
        case 1  
[lab1]=runSimulationWithTransfers(0,s0,AMSSTransfers2Shocks.Para,AMSSTransfers2Shocks.coeff,AMSSTransfers2Shocks.V,rhist0,NumSim);
        case 2
[lab2]=runSimulationWithTransfers(0,s0,AMSSTransfers3Shocks.Para,AMSSTransfers3Shocks.coeff,AMSSTransfers3Shocks.V,rhist0,NumSim);
    end
end
