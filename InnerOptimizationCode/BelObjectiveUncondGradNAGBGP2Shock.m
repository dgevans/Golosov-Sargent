function [ grad, user,iflag] = BelObjectiveUncondGradNAGBGP2Shock(n,z,user,iflag)
...
P = Par.P(1:2,1:2)./repmat(sum(Par.P(1:2,1:2),2),1,2);
    ...
    [c1,c2,gradc1,gradc2] = computeC2_2old(c1_1,c1_2,c2_1,R,s_,P,sigma)
    ...
    [ xprime,gradxprime ] = computeXprimeold( c1,gradc1,c2,gradc2,Rprime,gradRprime,l1,gradl1,l2,gradl2,...
