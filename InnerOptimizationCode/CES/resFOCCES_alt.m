function [ res, user,iflag] = resFOCCES_alt(n,z,user,iflag)
...
%xprime.
    ...
    gradV=alpha(1).* c1.^(-sigma).*gradc1...
        +alpha(2).* c2.^(-sigma).*gradc2...
        -alpha(1).*(l1.^gamma).*gradl1...
        -alpha(2).*(l2.^gamma).*gradl2...
        +beta*(V_R.*gradRprime)...
        -lambda.*gradxprime;
