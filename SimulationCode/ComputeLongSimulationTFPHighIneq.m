...
load ('~/Golosov-Sargent/Data/temp/cTFPHighIneq.mat');
g=Para.g;
n1=Para.n1;
n2=Para.n2;
...
Para.saveSimPath= ['~/Golosov-Sargent/Data/temp/SimulationTFPHighIneq.mat'];
rHist0 = rand(NumSim,1);
CoeffFileName='~/Golosov-Sargent/Data/temp/cTFPHighIneq.mat';
